...
#ifndef _APPLE3_FILETYPE_H
#define _APPLE3_FILETYPE_H
...
#define PRODOS_T_DA3    0x0A    /* Apple III BASIC data         */
#define PRODOS_T_WPF    0x0B    /* Generic word processing      */
#define PRODOS_T_SOS    0x0C    /* SOS system                   */
#define PRODOS_T_DIR    0x0F    /* Directory                    */
